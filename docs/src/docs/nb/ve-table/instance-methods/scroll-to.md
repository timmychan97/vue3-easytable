:::anchor scrollTo Rullemetode

:::demo 1. Rull tabellen til en angitt posisjon (px)<br>2. For parameterdetaljer, se [scrollTo](https://developer.mozilla.org/en-US/docs/Web/API/Element/scrollTo)
