:::anchor Filter med flere betingelser

:::demo Når filterboksen inneholder mange elementer, bruk egenskapen `maxHeight` til å angi maksimal høyde for filterboksen
