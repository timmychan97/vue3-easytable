::: anchor Egendefinert ikon

Tilbakalkallingsfunksjonen `filterIcon` støtter retur av et egendefinert ikon. Dette eksemplet bruker det innebygde ikonet `<ve-icon name="search" />`, men du kan også bruke andre ikonbiblioteker.
:::demo
