...
:::demo Å utvide en tabell er enkelt — returner bare en komponent som inneholder en tabell som innhold i `render`-funksjonen.
...
<script>
    // Dette eksempelet definerer en underordnet komponent inne i komponenten. Du kan også importere en komponent med `import`-nøkkelordet.
