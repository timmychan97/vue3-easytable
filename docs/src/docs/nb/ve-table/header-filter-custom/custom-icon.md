...
filterIcon-tilbakekallsfunksjonen stoetter retur av et egendefinert ikon. Her brukes det innebygde `<ve-icon name="search" />`-ikonet, men du kan ogsaa bruke andre ikonbibliotek
:::demo
