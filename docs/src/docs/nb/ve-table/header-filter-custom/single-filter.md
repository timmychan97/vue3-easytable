:::anchor Enkeltbetingelsesfilter

:::demo 1. `defaultVisible` angir om filteret er utvidet som standard<br>2. `render` er en renderfunksjon som angir det egendefinerte filterinnholdet. Parameteren `showFn` er funksjonen for aa utvide nedtrekkslisten, og `closeFn` er funksjonen for aa lukke nedtrekkslisten
