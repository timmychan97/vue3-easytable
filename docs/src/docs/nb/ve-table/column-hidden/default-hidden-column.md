:::anchor Standard skjulte kolonner

Folgende eksempel skjuler kolonnene hobby og name som standard

:::demo Sett standard skjulte kolonner via egenskapen `defaultHiddenColumnKeys`
