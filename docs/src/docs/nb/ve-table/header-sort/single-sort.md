:::anchor Sortering på ett felt

:::demo 1. Sortering på ett felt er standard oppførsel<br>2. Tilbakalkallingsfunksjonen `sortChange(params)` mottar kolonnens sorteringsregler
