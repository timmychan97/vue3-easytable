:::anchor Kombinert med lat innlasting

I noen situasjoner, på grunn av nettverksbåndbredde eller forespørselsbegrensninger, kan data bare hentes side for side, men du ønsker likevel å bruke virtuell rulling for å forbedre ytelsen. I slike tilfeller kan du bruke `scrolling` for å implementere virtuell rulling kombinert med lat innlasting. Følgende bruker simulerte data; tilpass til dine faktiske API-forespørsler.
