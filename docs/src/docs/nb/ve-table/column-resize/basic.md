:::anchor Dra kolonnebredde

Du kan holde musen mellom to kolonner og dra for a endre storrelse. Hvis kolonnebredden ikke er satt, er standarden 50px

:::demo 1. Sett minimumsbredden for kolonnedragning via `minWidth`<br>2. Fa tilbakemelding om kolonnedragningsendringer via `sizeChange({ column, differWidth, columnWidth })`
