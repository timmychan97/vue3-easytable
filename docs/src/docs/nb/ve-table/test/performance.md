:::demo Grunnleggende bruk

```html
<template>
    <div>
        <button @click="initData(100)">100 rader</button>
        &nbsp;
        <button @click="initData(1000)">1000 rader</button>
        &nbsp;
        <button @click="initData(3000)">3000 rader</button>
        &nbsp;
        <button @click="initData(10000)">10000 rader</button>
        &nbsp;
        <button @click="initData(100000)">100000 rader</button>
        &nbsp;
        <br />
        <br />
