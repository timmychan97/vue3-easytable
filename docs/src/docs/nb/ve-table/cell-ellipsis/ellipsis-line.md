:::anchor Flerlinjes ellipse

Denne funksjonen stotter for oyeblikket kun nettlesere som stotter [-webkit-line-clamp-egenskapen](https://developer.mozilla.org/en-US/docs/Web/CSS/-webkit-line-clamp)
:::demo Bruk `lineClamp` for a angi antall linjer for teksten avkortes
