:::anchor Lang tekst som bryter layouten

:::demo 1. Nar celletekstinnholdet er for langt, kan det bryte layouten. Du kan kontrollere dette med CSS-egenskapen [word-break](https://developer.mozilla.org/en-US/docs/Web/CSS/word-break)<br>2. Du kan ogsa kombinere dette med funksjonen [celleellipse](#/nb/doc/table/cell-ellipsis)
