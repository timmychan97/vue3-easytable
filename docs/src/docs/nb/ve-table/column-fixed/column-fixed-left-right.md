:::anchor Las kolonner pa begge sider

:::demo 1. Sett rulleomradets bredde via `scroll-width="1200"` og sett den ytre containerens bredde via `style="width:100%"`<br>2. Bruk `fixed:"left"` for a lase kolonner til venstre; bruk `fixed:"right"` for a lase kolonner til hoyre
