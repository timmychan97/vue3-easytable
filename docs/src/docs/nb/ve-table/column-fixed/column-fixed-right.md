:::anchor Las hoyre kolonner

:::demo 1. Sett rulleomradets bredde via `scroll-width="1200"` og sett den ytre containerens bredde via `style="width:100%"`<br>2. Bruk `fixed:"right"` for a lase kolonner til hoyre
