...
:::demo Hold musepekeren over indekskolonnen (kolonnen lengst til venstre) for å se innsettingsindikatoren for rader. Klikk på plusstegn-knappen for å sette inn en ny rad på den posisjonen.
