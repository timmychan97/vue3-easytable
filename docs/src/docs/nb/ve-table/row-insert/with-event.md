::: anchor Med hendelseshåndtering

:::demo Bruk hendelsen `@on-row-insert` for å håndtere radinnsetting. Hendelsen gir `insertRowIndex`, som angir hvor den nye raden skal settes inn.
