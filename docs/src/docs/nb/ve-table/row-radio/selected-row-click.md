::: anchor Radklikk for valg

Dette eksempelet demonstrerer valg utløst av radklikk. Du kan også oppnå kolonneklikk-valg gjennom «Tilpassede hendelser».
:::demo Kombiner kontrollerte egenskaper med «Tilpassede hendelser» for å oppnå radklikk-valg.
