:::anchor Kombinert med Element UI

:::demo 1. Du kan ogsa kombinere med Element UI-komponenter for dato-, tall-, nedtrekks- og andre redigeringsfunksjoner<br/>2. Merk: Komponenten kan komme i konflikt med hurtigtaster fra tredjepartsbiblioteker. I slike tilfeller kan du deaktivere cellevalg via `cellSelectionOption`
