:::demo Velg alle med deaktiverte elementer
...
<script>
    export default {
        ...
        computed: {
            ...
            // Deaktiverte avkryssede avkrysningsbokser
            disabledChecked() {
                let result = [];
            ...
            // Deaktiverte ikke-avkryssede avkrysningsbokser
            disabledUnChecked() {
                let result = [];
        ...
        methods: {
            ...
            checkAll() {
                ...
                // Ekskluder deaktiverte ikke-valgte elementer
