...
The filterIcon callback function supports returning a custom icon. This example uses the built-in `<ve-icon name="search" />` icon, but you can also use other icon libraries.
:::demo
